...
public class CustomerDaoMariaDB implements CustomerDao {
    ...
    @Override
    public void insertar(CustomerEntity obj) throws DataAccessException {
        try {
    ...
    @Override
    public void actualizar(CustomerEntity obj) throws DataAccessException {
        try {
    ...
    @Override
    public void eliminar(CustomerEntity obj) throws DataAccessException {
        try {
    ...
    @Override
    public List<CustomerEntity> obtenerTodos() throws DataAccessException {
        ...
        try {
            ...
            while (rs.next()) {
                CustomerEntity customer = rowMapper(rs);
                lista.add(customer);
            }
            return lista;
        } catch (SQLException ex) {
    ...
    @Override
    public CustomerEntity obtener(Integer id) throws DataAccessException {
        try {
    ...
    private CustomerEntity rowMapper(ResultSet rs) throws SQLException {
        ...
        return new CustomerEntity(id, name, address, website, creditLimit);
    }
}
