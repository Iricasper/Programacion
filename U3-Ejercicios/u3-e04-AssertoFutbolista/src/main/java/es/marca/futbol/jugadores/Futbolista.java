...
public class Futbolista {
    ...
    public Futbolista(String nombre, String apellidos) {
        ...
        assert (!this.nombre.isBlank()) : "El nombre esta vacio";
        assert (this.nombre != null) : "El nombre es nulo";
        assert (this.apellidos != null) : "Los apellidos son nulos";
        assert (!this.apellidos.isBlank()) : "Los apellidos estan vacios";
    }
